    ...
    <table cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="padding:0 0 28px;">
        ...
        <p style="margin:0;color:#B4B4BF;font-size:16px;line-height:1.55;">
          ...
          <strong style="color:#ffffff;">Tu potencial:</strong> ${audit.benchmark.tu_potencial}/10 si ejecutas ${audit.oportunidades.length === 1 ? 'la jugada de abajo' : `las ${audit.oportunidades.length} jugadas de abajo`}.
        </p>
      </td></tr>
      ...
      <tr><td style="padding:32px 0 12px;">
        <div style="font-size:11px;color:#8A8A96;letter-spacing:0.16em;text-transform:uppercase;font-weight:600;">
          ${audit.oportunidades.length === 1 ? 'La oportunidad principal' : `Las ${audit.oportunidades.length} oportunidades · en orden de impacto`}
        </div>
      </td></tr>
